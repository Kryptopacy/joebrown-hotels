...
export default function Footer({
  ...
  return (
    <footer className="relative text-[#E6CCB2] pt-24 pb-32 px-4 md:px-8 overflow-hidden" style={{ backgroundColor: '#1A0A02' }}>
      
      {/* Subtle Glowing Brand Aura in Background */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-white/5 blur-[130px] pointer-events-none rounded-full" />
      ...
      <div className="container mx-auto max-w-6xl relative z-10 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <p className="text-[#8D6E63] text-sm max-w-md leading-relaxed font-light">
          ...
          <div className="pt-4 flex flex-wrap gap-6 text-[11px] uppercase tracking-widest text-[#D7D3C8]">
            <span className="flex items-center gap-2"><Clock size={14} className="text-[#8D6E63]" /> 24/7 Front Desk</span>
            <span className="flex items-center gap-2"><ShieldCheck size={14} className="text-[#8D6E63]" /> Secure Premises</span>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-[13px] font-light">
            <li>
              <Link href="/rooms" className="text-[#8D6E63] hover:text-[#D4A373] transition-colors flex items-center gap-3">
                <BedDouble size={14} className="text-[#D4A373]" /> Rooms & Suites
              </Link>
            </li>
            <li>
              <Link href="/menu" className="text-[#8D6E63] hover:text-[#D4A373] transition-colors flex items-center gap-3">
                <Utensils size={14} className="text-[#D4A373]" /> Restaurant & Lounge Menu
              </Link>
            </li>
            <li>
              <Link href="/contact" className="text-[#8D6E63] hover:text-[#D4A373] transition-colors flex items-center gap-3">
                <MapPin size={14} className="text-[#D4A373]" /> Contact & Location
              </Link>
            </li>
            <li>
              <Link href="/admin" className="text-[#8D6E63] hover:text-[#D4A373] transition-colors flex items-center gap-3">
        ...
        <div>
          ...
          <ul className="space-y-5 text-[13px] font-light">
            <li className="flex items-start gap-3">
              ...
              <span className="text-[#8D6E63]">{hotelPhone}</span>
            </li>
            <li className="flex items-start gap-3">
              <Mail size={16} className="text-[#D4A373] shrink-0 mt-0.5" />
              <span className="text-[#8D6E63]">info@joebrownhotels.com</span>
            </li>
            <li className="flex items-start gap-3">
              <MapPin size={16} className="text-[#D4A373] shrink-0 mt-0.5" />
              <span className="text-[#8D6E63] leading-relaxed">{hotelAddress}</span>
            </li>
          </ul>
        </div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between text-[11px] tracking-widest text-[#5C554F] font-medium gap-4 uppercase">
        <p>© {new Date().getFullYear()} {hotelName}. All rights reserved.</p>
        <p className="flex items-center gap-2">
          Need a custom platform?{' '}
          <Link 
            href="/build-with-us" 
            className="text-brown-400 hover:text-white hover:underline font-semibold transition-colors"
          >
