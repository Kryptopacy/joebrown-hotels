...
export default function PendingApprovalPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFCEB] flex items-center justify-center p-4">
      <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl max-w-lg w-full text-center border-2 border-brown-500/30">
        <div className="w-20 h-20 bg-brown-500/20 text-brown-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-inner">
          <Clock size={40} />
        </div>
        
        <h1 className="text-3xl font-serif text-brown-300 font-bold mb-4">Pending Approval</h1>
        ...
        <div className="bg-brown-500/20 rounded-xl p-4 mb-8 border border-brown-100 flex items-start text-left gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button 
            ...
            className="px-6 py-3 bg-brown-500/20 text-brown-300 font-bold rounded-xl hover:bg-slate-200 transition-colors flex items-center justify-center gap-2"
          >
